...
public class TruckKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2235521869184439370L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TruckKey\",\"namespace\":\"com.example\",\"fields\":[{\"name\":\"customer\",\"type\":\"string\"},{\"name\":\"vehicle\",\"type\":\"string\"}]}");
   ...
   */
  public static com.example.TruckKey.Builder newBuilder() {
    return new com.example.TruckKey.Builder();
  }
   ...
   * @return A new TruckKey RecordBuilder
   */
  public static com.example.TruckKey.Builder newBuilder(com.example.TruckKey.Builder other) {
    if (other == null) {
      return new com.example.TruckKey.Builder();
    } else {
      return new com.example.TruckKey.Builder(other);
    }
  }
   ...
   * @return A new TruckKey RecordBuilder
   */
  public static com.example.TruckKey.Builder newBuilder(com.example.TruckKey other) {
    if (other == null) {
      return new com.example.TruckKey.Builder();
    } else {
      return new com.example.TruckKey.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TruckKey>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.TruckKey.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.TruckKey other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.customer)) {
        this.customer = data().deepCopy(fields()[0].schema(), other.customer);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckKey.Builder setCustomer(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckKey.Builder clearCustomer() {
      customer = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckKey.Builder setVehicle(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckKey.Builder clearVehicle() {
      vehicle = null;
