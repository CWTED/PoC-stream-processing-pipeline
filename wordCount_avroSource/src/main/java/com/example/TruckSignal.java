...
public class TruckSignal extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7028148371176676358L;
   ...
   */
  public static com.example.TruckSignal.Builder newBuilder() {
    return new com.example.TruckSignal.Builder();
  }
   ...
   * @return A new TruckSignal RecordBuilder
   */
  public static com.example.TruckSignal.Builder newBuilder(com.example.TruckSignal.Builder other) {
    if (other == null) {
      return new com.example.TruckSignal.Builder();
    } else {
      return new com.example.TruckSignal.Builder(other);
    }
  }
   ...
   * @return A new TruckSignal RecordBuilder
   */
  public static com.example.TruckSignal.Builder newBuilder(com.example.TruckSignal other) {
    if (other == null) {
      return new com.example.TruckSignal.Builder();
    } else {
      return new com.example.TruckSignal.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TruckSignal>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.TruckSignal.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.TruckSignal other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.customer)) {
        this.customer = data().deepCopy(fields()[0].schema(), other.customer);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckSignal.Builder setCustomer(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckSignal.Builder clearCustomer() {
      customer = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckSignal.Builder setVehicle(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckSignal.Builder clearVehicle() {
      vehicle = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckSignal.Builder setSignal(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckSignal.Builder clearSignal() {
      signal = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckSignal.Builder setValue(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckSignal.Builder clearValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckSignal.Builder setPadding(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckSignal.Builder clearPadding() {
      padding = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckSignal.Builder setTimestamp(java.time.LocalDateTime value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.TruckSignal.Builder clearTimestamp() {
