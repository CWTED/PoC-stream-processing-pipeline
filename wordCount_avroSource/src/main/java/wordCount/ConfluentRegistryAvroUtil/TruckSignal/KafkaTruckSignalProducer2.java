...
import wordCount.ConfluentRegistryAvroUtil.TruckSignal.TruckSignalGeneration.TruckSignalGenerator;

import java.time.LocalDateTime;
import java.time.ZoneId;
import java.util.Properties;

public class KafkaTruckSignalProducer2 {
    ...
    public static void main(String[] args) {
        ...
        props.put(ProducerConfig.TRANSACTIONAL_ID_CONFIG, "prod-2"); // Unique ID
